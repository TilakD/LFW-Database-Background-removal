...
custom_database_path = 'C:\Users\USER\Desktop\LWF DATABASE_BACK_REMOVE\resized_database_after_scale_normalization\s';
 %========================================================================%
...
[ca ch cv cd]=dwt2(face,'haar'); 
   dctface=ca;                %DCT of the image
    u=dctface(1:25,1:25);                %Extract 50x50 DCT-coefficients
    
    storeface{k} = reshape(u,1,625);    %Store in 1x2500 vector
    k = k+1;
...
NPar = 625;                             %Number of Dimensional Parameters
...
%--------------------------Feature Extraction-----------------------------%
  ...
  [ca ch cv cd]=dwt2(img,'haar'); 
    pic=ca;  
    pic_dct=reshape(pic(1:25,1:25),1,625);
